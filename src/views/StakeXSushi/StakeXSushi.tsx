        ...
        <StyledCardsWrapper>
          <StyledCardWrapper>
            <StyledInfo>
              ...
              of Ponchy held relative the weight of the staking. Ponchy can be
              minted by staking Ponchy. To redeem Ponchy staked plus swap fees
              convert Ponchy back to Ponchy.{' '}
              {totalSupply
